...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post todolists_url, params: { todolist: { complete: @todolist.complete, description: @todolist.description, user_id: @todolist.user_id } }
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { complete: @todolist.complete, description: @todolist.description, user_id: @todolist.user_id } }
